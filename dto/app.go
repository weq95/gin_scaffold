...
func (a *APPListInput) GetValidParams(ctx *gin.Context) error {
...
func (a *APPDetailInput) GetValidParams(ctx *gin.Context) error {
	return public.DefaultGetValidParams(ctx, a)
}
...
func (a *APPAddHttpInput) GetValidParams(ctx *gin.Context) error {
	return public.DefaultGetValidParams(ctx, a)
}
...
func (u *APPUpdateHttpInput) GetValidParams(ctx *gin.Context) error {
	return public.DefaultGetValidParams(ctx, u)
}
